...
const Navbar = () => {
  const linkClass =({isActive})=>isActive? 'text-white bg-black hover:bg-grey-900 hover:text-white rounded-md px-3 py-2':'text-white hover:bg-grey-900 hover:text-white rounded-md px-3 py-2';
  return (
    <>
